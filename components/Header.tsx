...
import StanleyLogo from '../assets/StanleyStudiosLLC-white-small.png';
    ...
    <header className="w-full p-2 md:p-4">
        <div className="flex flex-col md:flex-row items-center justify-start">
            ...
            <div className="text-center md:text-left mt-4 md:mt-0">
                <h1 className="app-title text-3xl md:text-5xl font-light text-gray-800 dark:text-gray-200">{title}</h1>
