import { r as reactExports, j as jsxRuntimeExports, D as DataTable, a as jszip, p as pdfmake, E as Exporter, u as useNavigate, L as Link, b as useParams, d as distExports, H as HashRouter, R as Routes, c as Route, e as ReactDOM, f as React } from "./vendor--rc3cVGO.js";
(function polyfill() {
...
const EntryTable = ({ entries }) => {
  ...
  const columns = [
    ...
    { title: "Reason", data: "reason" },
    {
      ...
      render: (data, type, row) => {
        if (!data) {
          return '<span class="text-red-500">Missing QR Code</span>';
        }
        return '<span class="text-green-500">Ready</span>';
      }
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const QR_CODE_BASE_URL = "https://vando.imagequix.com/s";
console.log("EntryDetailPage - QR_CODE_BASE_URL:", QR_CODE_BASE_URL);
const EntryDetail = () => {
  const { entry_id } = useParams();
  const navigate = useNavigate();
  const { getEntryById, loading, getEventById } = useData();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { loading, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex justify-center", children: entry.unique_id ? /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.QRCode, { value: `${QR_CODE_BASE_URL}${entry.unique_id}`, size: 256 }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500", children: "No QR code available. Please request a blank QR code." }) })
    ] })
  ] });
};
const App = () => {
